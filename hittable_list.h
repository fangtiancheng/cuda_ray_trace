...
sphere* hittable_list(){
    ...
    tmp_spheres[1] = sphere(point3(0.,0.,-1.), 0.5, material(color(0.7,0.3,0.3),LAMBERTIAN));
    tmp_spheres[2] = sphere(point3(-1.,0.,-1.), 0.5, material(color(0.8,0.8,0.8),METAL));
    tmp_spheres[3] = sphere(point3(-1.,0.,-1.), 0.5, material(color(0.8,0.6,0.3),METAL));
